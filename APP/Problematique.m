...
Y = log((2*acc_mes(1:2:55))./(vit_mes(1:2:55)).^2);
A = pinv(C)*Y
...
acc_appro = (0.5 * p0 * S * C_D0 * exp(-h_mes/hs) * vit_mes(1:2:55).^2)/m;

%Graphique approximer avec le vrai
figure
hold on
scatter(t, acc_mes, "red")
scatter(t_h_mes, acc_appro, "blue")
