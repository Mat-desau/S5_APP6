...
for n = 1:2
    ...
    V_vrai = V_ini*exp(0.5*B*hs*((P_vrai-p_ini)/sind(Gamma_ref(1))));
    V_prime = (((0.5)*B*hs*V_ini)/sind(Gamma_ref(1))) * P_prime * exp(0.5*B*hs*((P_vrai-p_ini)/sind(Gamma_ref(1)))); %avec 250 km/h
...
% 
% disp("h_min");
% texte = ["h min avec 250m/s : ", min(h_array)];
% disp(texte);
% texte = ["h min avec 300m/s : ", min(h_array)];
% disp(texte);
% disp("v_min");
% texte = ["v min avec 250m/s : ", min(vit_cal_RAA(:,1))];
% disp(texte);
% texte = ["v min avec 300m/s : ", min(vit_cal_RAA(:,2))];
% disp(texte);
% disp("h_max");
% texte = ["h max avec 250m/s : ", max(h_array)];
% disp(texte);
% texte = ["h max avec 300m/s : ", max(h_array)];
% disp(texte);
% disp("v_max");
% texte = ["v max avec 250m/s : ", max(vit_cal_RAA(:,1))];
% disp(texte);
% texte = ["v max avec 300m/s : ", max(vit_cal_RAA(:,2))];
% disp(texte);
